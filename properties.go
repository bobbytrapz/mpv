...
// 2019-01-27 19:19:25.622176043 -0500 EST m=+0.001653068
package mpv
...
// Vf gets 'vf' property
func (c *Client) Vf() (prop interface{}, err error) {
	return c.GetProperty("vf")
}

// Af gets 'af' property
func (c *Client) Af() (prop interface{}, err error) {
	return c.GetProperty("af")
}
...
// SetVf sets 'vf' property
func (c *Client) SetVf(value interface{}) error {
	return c.SetProperty("vf", value)
}

// SetAf sets 'af' property
func (c *Client) SetAf(value interface{}) error {
	return c.SetProperty("af", value)
}
